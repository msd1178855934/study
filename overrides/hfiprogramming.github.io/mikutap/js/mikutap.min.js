...
var MainManager = function() {
  ...
  var w, M, I, x, containerB, C = 0, g = 0, P = new function() {
      function a() {
          c && c()
      }
      function e(a, e) {
  ...
  , k = new function() {
      ...
      function r(a, e, n) {
          ...
          n = e + P.length,
          (e = G[n].length ? G[n].pop() : new k[e](containerX,n)).play(),
          F = 12 * Math.random() + 6),
          e = a % P.length,
          (e = 0 < G[e].length ? G[e].pop() : new P[e](containerX,e)).play()))
      }
      function l() {
          var a = Math.random();
      ...
      this.resize = function() {
          if (C) {
              ...
              for (var t = w / e, i = M / n, o = 0; o < n; o++)
                  for (var r = 0; r < e; r++) {
                      var l;
                      g[a] ? l = g[a] : (l = new d(a,containerU),
                      g[a] = l),
      ...
      this.init = function() {
          C = !0,
          containerX = new PIXI.Container,
          containerB.addChild(containerX),
          containerU = new PIXI.Container,
          containerB.addChild(containerU),
          (z = new function(parameterContainer) {
            var _this = this
                , i = 16777215
                , graphicsO = new PIXI.Graphics
                , parameterContainer_ = parameterContainer;
              function e() {
                  graphicsO.clear(),
                  graphicsO.beginFill(16777215),
                  graphicsO.drawRect(0, 0, w, M)
              }
              function n() {
                  _this.resize()
              }
              this.resize = function() {
                  graphicsO.clear(),
                  graphicsO.beginFill(i),
                  graphicsO.drawRect(0, 0, w, M)
              },
              this.flash = function() {
                  parameterContainer_.setChildIndex(graphicsO, parameterContainer_.children.length - 1);
                  for (var a = 0; 3 > a; a += 2)
              ...
              this.setColor = function(a, e) {
                  i = a,
                  0 <= e || (e = 0),
                  parameterContainer_.setChildIndex(graphicsO, e),
                  _this.resize()
              };
              parameterContainer_.addChild(graphicsO)
          }
          (containerX)).setColor(8965324, 0)
      }
      ,
      this.start = function() {
      ...
      ;
      var containerU, v = -1, y = 4, I = 8, x = !1, C = !1, g = [], P = [function(a, e) {
          function n() {
              s.visible = !1,
              G[i.id].push(i)
          }
      ...
      for (var containerX, F = 16 * Math.random(), G = [], B = 0; B < P.length + k.length; B++)
          G[B] = [];
