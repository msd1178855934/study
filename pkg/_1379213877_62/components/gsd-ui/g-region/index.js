var t = require("../../gsd-lib/utils/index").debounce, e = {
    range: [],
    valueIndex: []
};
...
Component({
    ...
    methods: {
        ...
        getRange: function(t) {
            var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 0, n = arguments[2], i = this.properties, r = i.level, a = i.value;
            if (e + 1 < r) {
