...
Component({
    ...
    methods: {
        ...
        getRegionData: function() {
            var t = this;
            return n = !0, this._retry = 3, Promise.all([ this.$request("https://fingertip-static.gdbs.gov.cn/static/city/1.json"), this.$request("https://fingertip-static.gdbs.gov.cn/static/city/2.json"), this.$request("https://fingertip-static.gdbs.gov.cn/static/city/3.json") ]).then(function(e) {
