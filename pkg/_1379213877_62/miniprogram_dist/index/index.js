    ...
    _downloadImageAndInfo: function(t, i, e) {
        ...
        return new Promise(function(s, n) {
            ...
            o._downImage(x, i).then(function(t) {
                ...
                var a = n.imgPath, x = n.imgInfo, d = void 0, l = void 0, u = t.borderRadius || 0, f = t.width, g = t.height, P = o.toRpx(x.width / e), v = o.toRpx(x.height / e);
                P / v <= f / g ? (d = 0, l = (v - P / f * g) / 2) : (l = 0, d = (P - v / g * f) / 2), 
                o.drawArr.push({
                    type: "image",
                    borderRadius: u,
