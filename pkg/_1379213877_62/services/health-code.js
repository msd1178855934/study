var e = getApp(), r = e.request, t = e.config, o = (e.wxp, t[t.env].healthCodePath);

exports.canSaveUserList = function(e) {
    return r({
        url: o + "/qrcCodeRelation/v1/canSaveUserList",
        method: "GET",
        data: e
    });
}, exports.getCodeUserList = function(e) {
    return r({
        url: o + "/qrcCodeRelation/v1/userList",
        method: "GET",
        data: e
    });
}, exports.getPassRegisterList = function(e) {
    return r({
        url: o + "/passRecord/v1/list",
        method: "GET",
        data: e
    });
}, exports.getRelationStateByUser = function(e) {
    return r({
        url: o + "/qrcCode/v1/relationStateByUser/" + e.uid + "?verCodes=" + e.verCodes + "&language=" + e.language,
        method: "GET"
    });
    ...
    return r({
        url: o + "/qrcCodeRelation/v1/save",
        method: "POST",
        data: e
    });
}, exports.removeCodeUser = function(e) {
    return r({
        url: o + "/qrcCodeRelation/v1/remove/" + e,
        method: "delete"
    });
}, exports.getGridPoint = function(e) {
    return r({
        url: o + "/grid-operator/v1/points/" + e.opearatorId,
        method: "GET"
    });
}, exports.removeGridPoint = function(e) {
    return r({
        url: o + "/grid-operator/v1/relieve",
        method: "POST",
        data: e
    });
}, exports.addGridPoint = function(e) {
    return r({
        url: o + "/grid-operator/v1/increase",
        method: "POST",
        data: e
    });
}, exports.passRegisterDays = function(e) {
    return r({
        url: o + "/passRegister/v1/days",
        method: "GET"
    });
}, exports.passRegisterList = function(e) {
    return r({
        url: o + "/passRecord/v1/list?qrcId=" + e + "&time=" + new Date().getTime(),
        method: "GET"
    });
}, exports.passRegisterSave = function(e) {
    return r({
        url: o + "/passRecord/v1/save",
        method: "POST",
        data: e
    });
}, exports.lastUserStatus = function(e) {
    return r({
        url: o + "/helper/v1/getReportByUid?uid=" + e,
        method: "GET"
    });
}, exports.infoByCodeId = function(e) {
    return r({
        url: o + "/qrcCode/v1/infoByCodeId/" + e,
        method: "GET"
    });
}, exports.getUserInfo = function(e) {
    return r({
        url: o + "/helper/v1/getUserInfo?uid=" + e,
        method: "GET"
    });
    ...
    return r({
        url: o + "/grid-manage/v1/authorize",
        method: "POST",
        data: e
    });
}, exports.deleteManagePerson = function(e) {
    return r({
        url: o + "/grid-manage/v1/relieve",
        method: "POST",
        data: e
    });
}, exports.getManagePerson = function(e) {
    return r({
        url: o + "/grid-manage/v1/operators/" + e,
        method: "GET"
    });
    ...
    return r({
        url: o + "/authentication/realname-aut/v1/" + e,
        method: "GET"
    });
    ...
    return new Promise(function(t, o) {
        r({
            ...
            "zh-CN" !== wx.T.locale && (e.isAut = 1), t(e);
        }).catch(function(e) {
            o(e);
        });
    });
    ...
    return r({
        url: o + "/qrcCode/v1/findCodeIdByInfo",
        method: "GET",
        data: e
    });
}, exports.verifyVerCode = function(e) {
    return r({
        url: o + "/qrcCode/v1/verifyVerCode/" + e,
        method: "GET"
    });
}, exports.getPassQrcCode = function(e, t, n) {
    return r({
        url: o + "/grid-operator/v1/qrcCode?operatorId=" + e + "&pointId=" + t + "&passRole=" + n,
        method: "GET"
    });
    ...
    return r({
        url: o + "/grid-operator/v1/findInfoByKey?key=" + e,
        method: "GET"
    });
}, exports.relationUserSave = function(e) {
    return r({
        url: o + "/communityPassReg/v1/save",
        method: "POST",
        data: e
    });
...
}, exports.createCodeByKey = function(e, t, n) {
    return r({
        url: o + "/grid-operator/v1/createCodeByKey?key=" + e + "&page=" + t + "&qrCodeKey=" + n,
        method: "GET"
    });
};