...
var n, i = Object.assign || function(e) {
    ...
    return e;
}, o = getApp(), s = o.Anim, r = o.Event, c = o.config, l = o.dayjs, u = o.userStore, d = require("../../../utils/util").chooseLocation, g = require("../../../services/report"), h = require("../../../services/region"), m = require("../../../services/health-code.js"), f = {
    username: "",
    reportName: "",
    phone: "",
    report: "",
...
s.Page({
    ...
    onLoad: function(e) {
        ...
        e.target && this.setData({
            activeTab: e.target
        }), u.fetchUserInfo().then(function(e) {
            e.uid && m.realnameUser(e.uid).then(function(e) {
                0 === e.isAut ? wx.showModal({
                    ...
                    confirmText: "立即上报",
                    success: function(e) {
                        e.confirm ? (console.log("立即上报"), n.getRegionData()) : e.cancel && (console.log("取消"), 
                        wx.reLaunch({
                            url: "/pages/stat/index"
                        }));
                    }
    ...
    getRegionData: function() {
        ...
        wx.showLoading(), h.getRegionData(t.regionCode, t.regionList).then(function(t) {
    ...
    handleSelfSubmit: function(e) {
        if (e.detail.validStatus) {
            ...
            delete t.regionData, wx.showLoading(), g.nCovSave(t).then(function(e) {
